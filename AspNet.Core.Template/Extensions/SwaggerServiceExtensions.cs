...
namespace AspNet.Core.Template.Extensions
{
    ...
    public static class SwaggerServiceExtensions
    {
        public static IServiceCollection AddSwaggerDocumentation(this IServiceCollection services, IConfiguration config)
        {
            ...
            services.AddSwaggerGen(
                options =>
                {
                    ...
                    options.IncludeXmlComments(XmlCommentsFilePath(config));
        ...
        public static string XmlCommentsFilePath(IConfiguration config)
        {
            var basePath = PlatformServices.Default.Application.ApplicationBasePath;
            //var fileName = typeof(Startup).GetTypeInfo().Assembly.GetName().Name + ".xml";
            var fileName = $"{config.GetValue<string>("App-Parameters:Swagger:FileCommentsName")}";
